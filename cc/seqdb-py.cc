...
PYBIND11_PLUGIN(seqdb_backend)
{
    ...
    py::class_<Tree, Node>(m, "Tree")
            ...
            .def("leaf_nodes_sorted_by_date", &Tree::leaf_nodes_sorted_by_date, py::return_value_policy::reference, py::doc("Leaks memory, use for debugging only!"))
