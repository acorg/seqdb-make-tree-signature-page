...
class AntigenicMaps
{
 public:
    ...
    virtual Viewport viewport_of(const Viewport& aViewport, const HzLineSections& aSections, size_t map_no) const = 0;
 ...
 protected:
    ...
    size_t number_of_shown_maps(const HzLineSections& aSections) const;
...
class AntigenicMapsGrid : public AntigenicMaps
{
 public:
    ...
    virtual Viewport viewport_of(const Viewport& aViewport, const HzLineSections& aSections, size_t map_no) const;

 protected:
    std::pair<size_t, size_t> grid(const SettingsAntigenicMaps& aSettings, const HzLineSections& aSections) const;
...
class AntigenicMapsVpos : public AntigenicMaps
{
 public:
    ...
    virtual inline Viewport viewport_of(const Viewport& aViewport, const HzLineSections& aSections, size_t map_no) const;
