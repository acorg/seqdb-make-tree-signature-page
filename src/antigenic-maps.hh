...
class AntigenicMaps
{
 public:
    ...
    virtual void calculate_viewports(Tree& aTree, const Viewport& aViewport, const Viewport& aPageArea, const DrawTree& aDrawTree, const HzLineSections& aSections, const SettingsAntigenicMaps& aSettings) = 0;
