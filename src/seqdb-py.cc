...
PYBIND11_PLUGIN(seqdb_backend)
{
    ...
    py::class_<SeqdbSeq>(m, "SeqdbSeq")
            ...
            .def("amino_acids", &SeqdbSeq::amino_acids, py::arg("aligned"))
            .def("nucleotides", &SeqdbSeq::nucleotides, py::arg("aligned"))
    ...
    py::class_<SignaturePage>(m, "SignaturePage")
            ...
            .def("prepare", &SignaturePage::prepare, py::arg("tree"), py::return_value_policy::take_ownership)
            .def("draw", &SignaturePage::draw, py::arg("tree"), py::arg("surface"))
            ;
